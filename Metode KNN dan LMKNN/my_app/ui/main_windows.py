...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_4.setText(_translate("MainWindow", "Mulai Klasifikasi"))
        self.radioButton.setText(_translate("MainWindow", "KNN"))
        self.radioButton_2.setText(_translate("MainWindow", "LMKNN"))
        self.label.setText(_translate("MainWindow", "Output Klasifikasi"))
        self.label_2.setText(_translate("MainWindow", "Detail Akurasi"))
